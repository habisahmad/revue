...
export type RequestReviewState = { success: boolean; error?: string; repoName?: string; prNumber?: string } | null;
...
export async function requestReview(
  ...
  return { success: true, repoName: repoName, prNumber: prNumber }
}
